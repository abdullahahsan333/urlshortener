...
<div class="w-full">
    <div class="flex items-center justify-between">
        <p class="text-xl pb-3">
            <i class="fas fa-list mr-3"></i> All Clients
        </p>

        <a href="{{ route('admin.client.create') }}" class="w-48 bg-white cta-btn font-semibold py-2 mt-5 rounded-br-lg rounded-bl-lg rounded-tr-lg hover:bg-gray-300 flex items-center gap-2 justify-center">
        ...
        <table class="min-w-full border border-gray-200 leading-normal">
            ...
            <tbody>
                ...
                @php
                    ...
                    $avatar = (!empty($client->avatar) ? asset($client->avatar) : asset('assets/images/client.webp'));
                ...
                @endphp
                    ...
                    <tr>
                            ...
                            <div class="flex items-center">
                                <div class="ml-3">
                                    <p class="text-gray-900 whitespace-no-wrap">
                                        {{ (!empty($client->name) ? strFilter($client->name) : "") }}
                                    </p>
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <p class="text-gray-900 whitespace-no-wrap">
                                {{ (!empty($client->mobile) ? $client->mobile : "") }}
                            </p>
                        </td>
                            ...
                            <div class="flex justify-end">
                                ...
                                <div id="dropdown{{ $key + 1 }}" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44">
                                    <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownDefaultButton{{ $key + 1 }}">
                                        <li>
                                            <a href="{{ route('admin.client.edit', $client->id) }}" class="flex justify-start gap-3 px-4 py-2 hover:bg-gray-100">
                                        ...
                                        <li>
                                            <a href="{{ route('admin.client.delete', $client->id) }}" class="flex justify-start gap-3 px-4 py-2 hover:bg-gray-100">
